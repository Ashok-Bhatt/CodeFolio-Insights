...
router.get("/user/recent-submissions", LeetCodeController.getRecentAcSubmissions);
...
router.get("/user/favorite-list", LeetCodeController.getCreatedPublicFavoriteList);
