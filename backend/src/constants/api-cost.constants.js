const API_POINTS_COST = [
    ...
    {
        baseUrl: "/platform/leetcode/contest/histogram", 
        cost: { base: 1 } 
    },
    {
        baseUrl: "/platform/leetcode/question/today", 
        cost: { base: 1 } 
    },
    {
    ...
    {
        baseUrl: "/platform/leetcode/contest/upcoming", 
        cost: { base: 1 } 
    },
    {
        baseUrl: "/platform/leetcode/contest/ranking/global", 
        cost: { base: 1 } 
    },
];
